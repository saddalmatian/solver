...
class IntervalConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        start : typing.Optional[global___LinearExpressionProto] = ...,
        end : typing.Optional[global___LinearExpressionProto] = ...,
        size : typing.Optional[global___LinearExpressionProto] = ...,
        ) -> None: ...
...
class CumulativeConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        capacity : typing.Optional[global___LinearExpressionProto] = ...,
        intervals : typing.Optional[typing.Iterable[builtins.int]] = ...,
        demands : typing.Optional[typing.Iterable[global___LinearExpressionProto]] = ...,
        ) -> None: ...
...
class ReservoirConstraintProto(google.protobuf.message.Message):
    ...
    a value t, then the current level changes by level_changes[i] (which is
    constant) at the time t. Therefore, at any time t:
    ...
    def time_exprs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___LinearExpressionProto]:
        ...
        pass
    @property
    def level_changes(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
    ...
    def __init__(self,
        *,
        min_level : builtins.int = ...,
        max_level : builtins.int = ...,
        time_exprs : typing.Optional[typing.Iterable[global___LinearExpressionProto]] = ...,
        level_changes : typing.Optional[typing.Iterable[builtins.int]] = ...,
        active_literals : typing.Optional[typing.Iterable[builtins.int]] = ...,
        ) -> None: ...
...
class ConstraintProto(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        int_div : typing.Optional[global___LinearArgumentProto] = ...,
        int_mod : typing.Optional[global___LinearArgumentProto] = ...,
        int_prod : typing.Optional[global___LinearArgumentProto] = ...,
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["constraint",b"constraint"]) -> typing.Optional[typing_extensions.Literal["bool_or","bool_and","at_most_one","exactly_one","bool_xor","int_div","int_mod","int_prod","lin_max","linear","all_diff","element","circuit","routes","table","automaton","inverse","reservoir","interval","no_overlap","no_overlap_2d","cumulative","dummy_constraint"]]: ...
...
class CpObjectiveProto(google.protobuf.message.Message):
    ...
    INTEGER_OFFSET_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal["coeffs",b"coeffs","domain",b"domain","integer_offset",b"integer_offset","integer_scaling_factor",b"integer_scaling_factor","offset",b"offset","scaling_factor",b"scaling_factor","scaling_was_exact",b"scaling_was_exact","vars",b"vars"]) -> None: ...
...
class FloatObjectiveProto(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        vars : typing.Optional[typing.Iterable[builtins.int]] = ...,
        coeffs : typing.Optional[typing.Iterable[builtins.float]] = ...,
        offset : builtins.float = ...,
        maximize : builtins.bool = ...,
        ) -> None: ...
...
class CpModelProto(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        floating_point_objective : typing.Optional[global___FloatObjectiveProto] = ...,
...
class CpSolverResponse(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        objective_value : builtins.float = ...,
        best_objective_bound : builtins.float = ...,
        additional_solutions : typing.Optional[typing.Iterable[global___CpSolverSolution]] = ...,
        ...
        integer_objective : typing.Optional[global___CpObjectiveProto] = ...,
        inner_objective_lower_bound : builtins.int = ...,
        num_booleans : builtins.int = ...,
        num_conflicts : builtins.int = ...,
        num_branches : builtins.int = ...,
